...
struct WordBankView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            Text("Teach Athenaeum which names, nicknames, and abbreviations refer to the same thing. Add yourself as \u{201C}me\u{201D}, your insurance as \u{201C}Kaiser\u{201D}, your school as \u{201C}WGU\u{201D} — chat will use these to find the right documents.")
            ...
            Toggle(isOn: $isSelf) {
                VStack(alignment: .leading, spacing: 2) {
                    Text("This entry is me")
                        .font(Japandi.Typography.body)
                        .foregroundStyle(Japandi.Colors.textPrimaryFB)
                    Text("When you say \u{201C}I\u{201D} or \u{201C}me\u{201D} in chat, Athenaeum will treat it as this name.")
                        .font(Japandi.Typography.caption)
                        .foregroundStyle(Japandi.Colors.textTertiaryFB)
                        .fixedSize(horizontal: false, vertical: true)
                }
